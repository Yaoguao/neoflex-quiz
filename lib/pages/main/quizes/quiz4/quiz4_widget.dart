                          ...
                          children: [
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 0.0, 220.0),
                              child: Text(
                                'Что такое Neoflex Reporting Risk?',
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  context.pushNamed(Quiz5Widget.routeName);
                                },
                                child: wrapWithModel(
                                  ...
                                  child: AnswersWidget(
                                    answer: false,
                                    answerText: 'Решение для расчёта рисков',
                                    answerV: 'C',
                                    check: false,
                                  ),
                                ),
