...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: PointsWidget.routeName,
          path: PointsWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Points')
              : PointsWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: QuizSuccessWidget.routeName,
          path: QuizSuccessWidget.routePath,
          builder: (context, params) => QuizSuccessWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: Quiz6Widget.routeName,
          path: Quiz6Widget.routePath,
          builder: (context, params) => Quiz6Widget(),
        ),
        FFRoute(
          name: Quiz7Widget.routeName,
          path: Quiz7Widget.routePath,
          builder: (context, params) => Quiz7Widget(),
        ),
        FFRoute(
          name: Quiz8Widget.routeName,
          path: Quiz8Widget.routePath,
          builder: (context, params) => Quiz8Widget(),
        ),
        FFRoute(
          name: Quiz9Widget.routeName,
          path: Quiz9Widget.routePath,
          builder: (context, params) => Quiz9Widget(),
        ),
        FFRoute(
          name: Quiz10Widget.routeName,
          path: Quiz10Widget.routePath,
          builder: (context, params) => Quiz10Widget(),
        )
